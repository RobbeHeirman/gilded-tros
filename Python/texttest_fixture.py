...
if __name__ == "__main__":
    ...
    items = [
        ...
        Item(name="Ring of Cleansening Code", sell_in=0, quality=20),
        ...
        Item(name="Backstage passes for Re:Factor", sell_in=10, quality=30),
        Item(name="Backstage passes for HAXX", sell_in=5, quality=49),
        Item(name="Backstage passes for HAXX", sell_in=5, quality=21),
        Item(name="Backstage passes for HAXX", sell_in=0, quality=21),
